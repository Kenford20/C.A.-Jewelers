...
class WomensWeddingRings extends Component {
    state = {
        products: [],
        numProducts: 0,
    };
    ...
    render() { 
        return ( 
            <div id="womens-wedding-rings-page">
                <GlobalHeader/>
                <CatalogTop heading="Womens Wedding Bands" 
                    categoryRoute="/wedding"
                    categoryRouteName="WEDDING"
                    subcategoryRouteName="WOMENS WEDDING BANDS" 
